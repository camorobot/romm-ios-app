...
public struct ClientValidationError<T: Error & Hashable>: Error {
...
public struct Validator {
    ...
    /// - Throws: `ClientValidationError<StringValidationErrorKind>` if the string is invalid against the rule,
    ///           `NSError` if the rule.pattern is invalid.
    public static func validate(_ string: String, against rule: StringRule) throws -> String {
        var error = ClientValidationError<StringValidationErrorKind>(kinds: [])
    ...
    /// - Throws: `ClientValidationError<NumericValidationErrorKind>` if the numeric is invalid against the rule.
    public static func validate<T: Comparable & BinaryInteger>(_ numeric: T, against rule: NumericRule<T>) throws -> T {
        var error = ClientValidationError<NumericValidationErrorKind>(kinds: [])
    ...
    /// - Throws: `ClientValidationError<ArrayValidationErrorKind>` if the string is invalid against the rule.
    public static func validate(_ array: Array<AnyHashable>, against rule: ArrayRule) throws -> Array<AnyHashable> {
        var error = ClientValidationError<ArrayValidationErrorKind>(kinds: [])
