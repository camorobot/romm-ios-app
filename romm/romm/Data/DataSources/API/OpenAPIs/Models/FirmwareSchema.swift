...
public struct FirmwareSchema: Codable, JSONEncodable, Hashable {
    ...
    public init(id: Int, fileName: String, fileNameNoTags: String, fileNameNoExt: String, fileExtension: String, filePath: String, fileSizeBytes: Int, fullPath: String, isVerified: Bool, crcHash: String, md5Hash: String, sha1Hash: String, missingFromFs: Bool, createdAt: Date, updatedAt: Date) {
        self.id = id
